#!/bin/bash
# ============================================================
# QTNUnet 训练启动脚本 (Gaofen 数据集, level0, 单尺度)
# 用法: bash train/train_qtnUnet_gaofen.sh
# ============================================================
...
# ============================================================
echo "========================================"
echo "  QTNUnet Training on Gaofen (level0)"
echo "========================================"

python train/train_qtnUnet_gaofen.py \
