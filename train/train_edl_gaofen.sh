#!/bin/bash
# ============================================================
# SPPrompt-Water + EDL 训练启动脚本 (Gaofen_processed_v2, level0)
# 用法: bash train/train_edl_gaofen.sh
# ============================================================
...
TASK_NAME="SPP_Gaofen_EDL"

LOG_DIR="${WORK_DIR}/logs"
mkdir -p "${LOG_DIR}"
TIMESTAMP=$(date +"%Y%m%d-%H%M%S")
LOG_FILE="${LOG_DIR}/train_edl_gaofen_${TIMESTAMP}.log"
...
# ============================================================
FREEZE_PROMPT="false"
USE_AMP="false"               # Gaofen 上建议关闭 AMP，避免 nan
USE_WANDB="false"
USE_REFEREE="false"
RESUME=""
...
{
  echo "========================================"
  echo "  SPPrompt-Water + EDL (Gaofen) Training"
...
python train/train_edl_gaofen.py \
