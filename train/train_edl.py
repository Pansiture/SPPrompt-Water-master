...
def validate(prompt_water_net, val_dataloader, device, epoch, num_epochs, use_referee=False, kl_scale=0.5, kl_anneal_ratio=0.5, referee_weight=0.1):
...
def main():
    ...
    # Separate learning rates: base params (pretrained backbone) vs new EDL head
    base_params = []
    edl_new_params = []
