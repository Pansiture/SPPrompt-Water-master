#!/usr/bin/env python
"""
MECNet 训练脚本 (Gaofen 数据集, level0, 单尺度)
基于 train_deeplabv3_gaofen.py 修改
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--task_name", type=str, default="Golden_MECNet")
    ...
    logger.info("=" * 60)
    logger.info("Training MECNet on Golden (level0)")
    logger.info("=" * 60)
