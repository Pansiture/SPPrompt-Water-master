...
# -*- coding: utf-8 -*-
"""
Training script for QTNUnet on GID dataset (level0, single-scale).
"""
import argparse
import logging
import sys
...
def main():
    ...
    parser.add_argument("--task_name", type=str, default="QTNUnet_GID")
    ...
    # ---- model ----
    # QTNUnet: embed_dims needs 5 elements for num_stages=5
    model = qtnUnet(
