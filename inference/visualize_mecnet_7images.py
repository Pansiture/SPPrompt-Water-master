...
# -*- coding: utf-8 -*-
"""
Visualize MECNet inference on 7 selected images from GLH-Water level0 val.
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/work_dir/GLH_MECNet_9epoch_e3_0.6935_2.3675/GLH_MECNet_9epoch_e3_0.6935_2.3675.pth")
    parser.add_argument("--val_dir", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/data/GLH-water/level0/val")
    parser.add_argument("--out_dir", type=str, default="./visualize_results_mecnet_7images")
