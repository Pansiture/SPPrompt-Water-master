#!/usr/bin/env python
"""
推理脚本：使用 UNet 权重在 GID_processed val 集上逐张推理，
...
def main():
    ...
    parser.add_argument("--resume", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/work_dir/GID_UNet_27epoch_e20_0.7482_2.5151/GID_UNet_27epoch_e20_0.7482_2.5151.pth")
    parser.add_argument("--output_dir", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/output/eval_gid_unet_val")
    parser.add_argument("--out_channels", type=int, default=1)
    parser.add_argument("--save_visuals", type=int, default=1, help="1=save pred masks, 0=don't save")
    parser.add_argument("--batch_on_gpu", type=int, default=1, help="Inference batch size on GPU")
    ...
    for img_path in tqdm(img_list, desc="Evaluating"):
        ...
        # Resize prob to GT size if needed (usually same size 1024)
    ...
    # --- 汇总总体指标 ---
    # 用 numpy 方式再算一次全局，避免 GPU 累积
    # 这里直接用单图结果的平均来近似，也可以重新遍历，但平均 mIoU 就是总体 mIoU 的常用定义
