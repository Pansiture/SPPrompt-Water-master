#!/usr/bin/env python
"""
推理脚本：使用 SwinTransformerNet 权重在 GID_processed val 集上逐张推理，
...
def main():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/output/eval_gid_swin_val")
    ...
    for img_path in tqdm(img_list, desc="Evaluating"):
        ...
        # Resize prob to GT size if needed (Swin outputs 1024x1024 from 256x256 upsample, but check)
