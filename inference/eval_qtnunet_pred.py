...
from SPP_model.modeling.other_model.QTNUnet.qtnUnet import qtnUnet
...
def main():
    ...
    parser.add_argument("--resume", type=str, required=True, help="QTNUnet checkpoint path")
    parser.add_argument("--image_folder", type=str,
                        default="/root/autodl-tmp/SPPrompt-Water-master/data/GID_processed/level0/val/imgs")
    parser.add_argument("--output_dir", type=str, default="/root/autodl-tmp/SPPrompt-Water-master/output/qtnunet_pred")
